...
export default function InviteGuardScreen() {
  const { user } = useAuth();
  ...
  return (
    <View className="flex-1 items-center justify-center">
      <Text className="text-4xl font-bold">Invitar Guardia</Text>

      <View>
        <Text className="text-2xl mt-4">Formulario de invitación para guardias</Text>
        <Text className="text-lg mt-2">Email:</Text>
        <TextInput
          className="border p-2 rounded w-full"
          value={email}
          onChangeText={setEmail}
          placeholder="Ingrese el email del guardia"
        />
        ...
        <TextInput
          ...
          placeholder="Ingrese el apellido del guardia"
        />
